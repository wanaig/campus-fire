...
public class InspectionItemController {
    ...
    public static class Request{@NotBlank public String facilityType;@NotBlank public String itemCode;@NotBlank public String itemName;public String inspectionStandard;@NotNull public Boolean requiredFlag=true;public Integer sortOrder=0;public Boolean enabled;}
}
